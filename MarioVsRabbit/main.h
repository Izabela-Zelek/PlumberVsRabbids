...
int m_enemiesDefeated = 0; //amount of enemies 'killed'
...
bool m_sonicUsed = false;
bool m_peelingUsed = false;
bool m_doughUsed = false;

int modeRabbit = -1; //used for determining whether a defense will work
int playerMode = -1; //used for determining whether a defense will work

int m_xp = 0; //stores the amount of xp the player has
int m_coins = 0; //stores the amount of coins the player has

static int m_currentEnemy = 0; //the enemy the player is currently fighting
...
private:
	...
	//strings containing the text that shows up at each attack
